...
# =========================================================
def create_silver_stg_customers(spark):
...
# =========================================================
def create_gold_agg_sales_by_city(spark):
...
def create_gold_ranking_customers(spark):
...
def main():
    ...
    # Silver
    create_silver_stg_customers(spark)
    ...
    # Gold
    create_gold_agg_sales_by_city(spark)
    create_gold_agg_sales_by_category(spark)
    create_gold_ranking_customers(spark)
